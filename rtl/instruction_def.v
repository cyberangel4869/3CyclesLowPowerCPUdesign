...
// Target Devices: 
// Tool Versions: 
// Description: 定义11条指令的OPCODE/FUNCT域
// 
// Dependencies: 
// 
// Revision:
...
`define INSTR_SLLI_FUNCT   3'b001  //SLLI
`define INSTR_SRLI_FUNCT   3'b101  //SRLI
`define INSTR_XORI_FUNCT   3'b100  //XORI
`define INSTR_ORI_FUNCT    3'b110  // ORI 指令的Funct
`define INSTR_ANDI_FUNCT   3'b111  //SLLI